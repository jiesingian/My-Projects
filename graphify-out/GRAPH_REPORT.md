# Graph Report - My-Projects  (2026-09-02)

## Corpus Check
- 88 files · ~27,674 words
...
## Knowledge Gaps
- **2 isolated node(s):** `graphify`, `graphify`
...
- **What connects `graphify`, `graphify` to the rest of the system?**
