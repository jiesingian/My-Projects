...
export default function OfflinePage() {
  return (
    <div style={{ padding: "48px 22px", maxWidth: 420, margin: "0 auto" }}>
      <Blueprint style={{ padding: "22px 18px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
          <Icon name="info" size={18} style={{ color: "var(--color-accent-700)" }} />
          <h1 style={{ font: "600 20px/1.2 var(--font-heading)", margin: 0 }}>No connection</h1>
        </div>

        <p style={{ fontSize: 14, lineHeight: 1.5, color: "var(--color-neutral-800)", margin: "0 0 14px" }}>
        ...
        <p style={{ fontSize: 13.5, lineHeight: 1.5, color: "var(--color-neutral-700)", margin: "0 0 14px" }}>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          <a href="/household?seg=buy" className="btn btn-primary" style={{ minHeight: 38, fontSize: 13.5, padding: "0 14px" }}>
            The list
          </a>
          <a href="/planner" className="btn btn-secondary" style={{ minHeight: 38, fontSize: 13.5, padding: "0 14px" }}>
            The calendar
          </a>
        </div>
      </Blueprint>
