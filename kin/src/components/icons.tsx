...
export const iconPaths = {
  ...
  wifi: "M2.5 9a13.5 13.5 0 0 1 19 0M5.5 12.3a9.2 9.2 0 0 1 13 0M8.6 15.5a4.8 4.8 0 0 1 6.8 0M12 19h.01",
  eye: "M2.5 12s3.5-6.5 9.5-6.5s9.5 6.5 9.5 6.5s-3.5 6.5-9.5 6.5S2.5 12 2.5 12M12 9.2a2.8 2.8 0 1 0 0 5.6a2.8 2.8 0 0 0 0-5.6",
  eyeOff: "M3 3l18 18M10.6 5.6A9.6 9.6 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-2.7 3.4M6.6 6.7C3.9 8.4 2.5 12 2.5 12s3.5 6.5 9.5 6.5a9.3 9.3 0 0 0 4.6-1.2M10 10a2.8 2.8 0 0 0 4 4",
  settings:
  ...
  search: "M10.5 4a6.5 6.5 0 1 0 0 13a6.5 6.5 0 0 0 0-13M15.4 15.4 20.5 20.5",
  mic: "M12 3.5a3 3 0 0 0-3 3v5a3 3 0 0 0 6 0v-5a3 3 0 0 0-3-3M5.5 11a6.5 6.5 0 0 0 13 0M12 17.5v3.5",
  poll: "M5 20.5V13M10 20.5V4M15 20.5v-9M20 20.5V8",
  stop: "M7 7h10v10H7z",
  ...
  phone: "M5 3.5h3.5l1.8 4.6-2.3 1.4a11 11 0 0 0 6.5 6.5l1.4-2.3 4.6 1.8V19a1.5 1.5 0 0 1-1.5 1.5A16.5 16.5 0 0 1 3.5 5 1.5 1.5 0 0 1 5 3.5z",
  phoneOff: "M3 3l18 18M10.1 13.9a11 11 0 0 1-2.1-4.4l2.3-1.4-1.8-4.6H5A1.5 1.5 0 0 0 3.5 5a16.5 16.5 0 0 0 5 11.4M13.5 16a11 11 0 0 0 1.5.5l1.4-2.3 4.6 1.8V19a1.5 1.5 0 0 1-1.5 1.5 16.4 16.4 0 0 1-6.2-1.6",
  video: "M3 6.5h12v11H3zM15 10.5l6-3.5v10l-6-3.5",
  videoOff: "M3 3l18 18M15 10.5l6-3.5v10l-6-3.5M9.5 6.5H15v5.5M15 15.5v2H3v-11h1.5",
  micOff: "M3 3l18 18M9 9v2.5a3 3 0 0 0 5.1 2.1M15 10.5v-4a3 3 0 0 0-5.7-1.3M18 11.5a6 6 0 0 1-.9 3.1M6 11.5a6 6 0 0 0 9.3 5M12 17.5v3",
  ...
  mapPin: "M12 21.5c4.5-5 7-8.4 7-11.5a7 7 0 1 0-14 0c0 3.1 2.5 6.5 7 11.5M12 7.5a2.6 2.6 0 1 0 0 5.2a2.6 2.6 0 0 0 0-5.2",
  ...
  message: "M4 5.5h16v11H9l-4 3.5v-3.5H4zM8.5 11h.01M12 11h.01M15.5 11h.01",
  sparkle: "M12 3.5 13.7 9l5.3 1.7-5.3 1.7L12 17.7l-1.7-5.3L5 10.7 10.3 9zM18.5 16.5l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7z",
  // Meals
